...
#if (defined(SPIFFS_TARGET) || (!defined(SPIFFY_SRC_MK)))
/* If SPIFFY_SRC_MK is not defined it means we are compiling for the ESP */
#include "user_config.h"
#include "user_interface.h"
#include "../libc/c_stdio.h"
#include "../libc/c_stdint.h"
#else
/* If SPIFFY_SRC_MK -is- defined it means we are compiling for SPIFFY/Linux,  *
 * so we must include the compiling system's C headers. We also need to       *
 * define a couple types & methods that are defined differently under Linux   */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <stddef.h>
...
/* ---------------------------- Semi-Static Config -------------------------- */
#ifndef STATFS_ERASE_BLK_SZ
#define STATFS_ERASE_BLK_SZ               (4*1024)
#endif
#ifndef STATFS_LOG_BLK_SZ
#define STATFS_LOG_BLK_SZ                 (8*1024)
#endif
#ifndef STATFS_PHYS_SZ
#define STATFS_PHYS_SZ                    0x10000  // SPIFFS0_SIZE
#endif
#ifndef STATFS_FIXED_LOCATION
#define STATFS_FIXED_LOCATION             0x302000 // SPIFFS0_ADDR
#endif
/* ----------------------------- Dynamic Config ----------------------------- */
#ifndef DYNFS_ERASE_BLK_SZ
#define DYNFS_ERASE_BLK_SZ                (4*1024)
#endif
#ifndef DYNFS_LOG_BLK_SZ
#define DYNFS_LOG_BLK_SZ                  (32*1024)
#endif
#ifndef DYNFS_PHYS_SZ
#define DYNFS_PHYS_SZ                     0x50000 // SPIFFS1_SIZE
#endif
#ifndef DYNFS_FIXED_LOCATION
#define DYNFS_FIXED_LOCATION              0x312000 // SPIFFS1_ADDR
#endif
