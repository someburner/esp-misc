...
#include "sign_ge25519.h"
#include "sign_sc25519.h"
...
int crypto_sign_ed25519(
    unsigned char *sm,uint16_t *smlen,
    const unsigned char *m,uint16_t mlen,
...
int crypto_sign_ed25519_open(
    unsigned char *m,uint16_t *mlen,
    const unsigned char *sm,uint16_t smlen,
